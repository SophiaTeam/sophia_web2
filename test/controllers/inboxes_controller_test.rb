...
class InboxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inbox" do
    assert_difference('Inbox.count') do
      post inboxes_url, params: { inbox: { content: @inbox.content, title: @inbox.title, user_id: @inbox.user_id } }
    end
  ...
  test "should update inbox" do
    patch inbox_url(@inbox), params: { inbox: { content: @inbox.content, title: @inbox.title, user_id: @inbox.user_id } }
